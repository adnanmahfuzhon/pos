        ...
        <div className="flex gap-4">
          <div className="relative hidden md:block">
            ...
            <input
              ...
              className="pl-12 pr-6 py-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl outline-none text-xs font-bold w-64 focus:ring-2 focus:ring-orange-500/20"
            />
          </div>
          <button
            onClick={() => openModal()}
                ...
                return (
                  <tr key={product.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors group">
                    ...
                    <td className="px-8 py-6 text-right">
                      ...
                      <div className="group-hover:hidden text-slate-200 dark:text-slate-800">
                        <MoreHorizontal className="w-6 h-6 ml-auto" />
                      </div>
                    </td>
                  </tr>
                );
